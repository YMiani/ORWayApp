...
import {SafeAreaView, Text, StatusBar, StyleSheet, View, Image, TouchableOpacity, ScrollView } from "react-native";
...
import { renderUpdate, setRenderUpdate } from './Database/DatabaseView';
    ...
    return (
      <ScrollView>
        <View style={styles.container}>
          ...
          <TouchableOpacity onPress={() => this.restartContext()} style={styles.btnBack}><Text>Voltar para tela inicial</Text></TouchableOpacity>  
        </View>
      </ScrollView>	
    )}
  }
