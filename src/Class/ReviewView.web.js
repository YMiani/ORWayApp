                    ...
                    <View style={styles.containerWeb}>
                        ...
                        <View style={styles.containerWeb}>
                            {this.state.num_prod.map((num_prod, i) => {
                                return (
                                    <View style={styles.containerWeb} key={'view' + i}>
                                        ...
                                        <TouchableOpacity key={'touchable' + i} onPress={() => this.props.navigation.navigate('ReviewEdit', { itemId: 4, state: i })} style={styles.btnEditWeb}><Icon name="pencil-square" size={35} color="white" /></TouchableOpacity>
                                    </View>
                                )
                            })}
                        </View>
                        ...
                        <View style={styles.containerWeb}>
                            {this.state.num_res.map((num_res, i) => {
                                return (
                                    <View style={styles.containerWeb} key={'viewRes' + i}>
                        ...
                        <View style={styles.containerWeb}>
                            {this.state.num_res.map((num_res, i) => {
                                return (
                                    <View style={styles.containerWeb} key={'viewAvail' + i}>
                                        ...
                                        <TouchableOpacity key={'touchableAvail' + i} onPress={() => this.props.navigation.navigate('ReviewEdit', { itemId: 6, state: i })} style={styles.btnEditWeb}><Icon name="pencil-square" size={35} color="white" /></TouchableOpacity>
                                    </View>
                                )
                            })}
                        </View>
                        ...
                        <View style={styles.containerWeb}>
                            {this.state.num_prod.map((num_prod, i) => {
                                return (
                                    <View style={styles.containerWeb} key={'viewSpend' + i}>
                                        ...
                                        <TouchableOpacity key={'touchableSpend' + i} onPress={() => this.props.navigation.navigate('ReviewEdit', { itemId: 7, state: i })} style={styles.btnEditWeb}><Icon name="pencil-square" size={35} color="white" /></TouchableOpacity>
                                    </View>
                                )
                            })}
                        </View>
